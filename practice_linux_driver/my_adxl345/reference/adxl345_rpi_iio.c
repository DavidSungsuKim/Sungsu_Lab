...
/*
 * root@raspberrypi:/home/pi# insmod /lib/modules/4.9.80-v7+/kernel/drivers/iio/buffer/industrialio-triggered-buffer.ko 
 * root@raspberrypi:/home/pi# cd /root/
 * root@raspberrypi:~# insmod adxl345_rpi_iio.ko
 */
